                ...
                <header className="sticky top-0 z-30 border-b border-white/10 bg-[#06101f]/95 px-4 pb-4 pt-4 backdrop-blur-xl">
                    ...
                    <nav className="mt-4 grid grid-cols-3 rounded-2xl bg-white/5 p-1">
                        <button
                            ...
                            className={`rounded-xl px-2 py-2.5 text-xs font-medium transition ${vistaActiva === "descubrir"
                        ...
                        <button
                            ...
                            className={`rounded-xl px-2 py-2.5 text-xs font-medium transition ${vistaActiva === "seguidores"
                                ? "bg-blue-500 text-white"
                                : "text-slate-500"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`rounded-xl px-2 py-2.5 text-xs font-medium transition ${vistaActiva === "siguiendo"
                                ? "bg-blue-500 text-white"
                                : "text-slate-500"
                                }`}
                        >
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        <button
                                            type="button"
                                            onClick={() => navigate(`/usuario/${persona.id}`)}
                                            aria-label={`Abrir perfil de ${persona.nombre}`}
                                            className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-br ${persona.color} font-bold transition hover:scale-105 active:scale-95`}
                                        >
                                            {persona.iniciales}
                                        </button>
                                    ...
                                    <div className="mt-4 flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs font-semibold transition active:scale-95 ${siguiendo
