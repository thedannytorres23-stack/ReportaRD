...
const opcionesIniciales = [
    {
        id: "santiago-matias",
        nombre: "Santiago Matías Alofoke",
        votos: 60,
        color: "from-amber-400 to-orange-500",
    },
    {
        id: "David Collado",
        nombre: "David Collado",
        votos: 40,
...
const CLAVE_VOTO =
    "reportard_poll_presidencia_2028_v1";
                    ...
                    <div className="flex min-w-0 items-start gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <h2 className="mt-1 font-bold leading-snug text-white">
                                ¿Quién te gustaría que fuera el próximo presidente de República Dominicana?
                            </h2>
                        </div>
                    </div>
                    ...
                    {opciones.map((opcion) => {
                        ...
                        return (
                            <button
                                ...
                                className={`group relative w-full overflow-hidden rounded-2xl border px-4 py-3 text-left transition ${seleccionada
